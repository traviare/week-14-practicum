...
const myFirstArray = ["Привет!", 123, false];
...
const mySecondArray = ["Москва", "Рига", "Алматы", "Берлин"];
...
const myInformation = ["Виолетта", 09, 11, "Скорпион"];
...
const countrieFirstElement = countries.shift();
console.log(countrieFirstElement);
...
const colorsConsole = colors.forEach((color) => {
  console.log(color);
});
...
let randomNumbersTwo = [...randomNumbers];
